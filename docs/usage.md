...
| Command | Description |
| --------- | ------------- |
| `nerdfetch_nopasswd` | when nerdfetch is installed, it removes the need for a sudo password when running `sudo nerdfetch` |
| `nerdfetch_passwd` | when nerdfetch is installed, it adds the need for a sudo password when running `sudo nerdfetch` |
